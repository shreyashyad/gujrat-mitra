...
function FashionCard({ article }) {
  ...
  return (
    <div
      ...
      className="group flex w-full h-full items-stretch gap-2.5 cursor-pointer md:min-h-[102px]
    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-between min-w-0">
        <p className="article-headline line-clamp-3 md:!h-auto md:!leading-[1.35]">
