...
export default function MainGrid({ children }) {
  ...
  return (
    <>
      {/* Sidebar (WidgetRail) — desktop only (1024px+). Tablet/phone: full-width content. */}
      <div className="grid grid-cols-1 items-start gap-4 lg:grid-cols-[minmax(0,1fr)_260px] xl:grid-cols-[minmax(0,1fr)_295px] xl:gap-6">
        ...
        <aside className="hidden w-full min-w-0 py-6 pl-0 pr-0 lg:block lg:pl-1 lg:pr-1 lg:sticky lg:bottom-6 lg:self-end">
