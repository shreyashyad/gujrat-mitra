...
export default function HeroArticleCard({ article, categoryLabel }) {
    ...
    return (
        <div
            ...
            className="group flex flex-col h-full cursor-pointer rounded-lg overflow-hidden hover:-translate-y-0.5 transition-all duration-300 ease-out active:scale-[0.985]"
        >
            {/* Image Container */}
            ...
            <div className="mt-1 md:mt-4.5 px-0 md:px-1 flex-1">
            ...
            {/* MetaRow pinned below headline; mt-auto keeps hero bottom aligned */}
