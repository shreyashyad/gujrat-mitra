...
function ImageCard({ article }) {
  ...
  return (
    <div
      ...
      className="group flex h-full flex-col justify-between md:min-h-[265px] cursor-pointer p-0
...
export default function SportsNewsSection() {
  ...
  return (
    <section className="mt-[3px] md:items-stretch shadow-[0_2px_3px_rgba(0,0,0,0.06),0_0_20px_rgba(0,0,0,0.06)] p-7 bg-white dark:bg-[#121212] border border-gray-200/70 dark:border-white/10 rounded-3xl">
      {/* Single desktop layout from md+ (≥768): 4 columns */}
      <div className="grid grid-cols-2 gap-6 md:grid-cols-4 md:items-stretch">
        {cards.map((article) => (
