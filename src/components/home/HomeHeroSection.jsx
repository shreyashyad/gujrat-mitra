...
function SideCardWithImage({ article }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-between min-w-0 gap-1 md:min-h-[110px]">
    ...
    >
      ...
      <div className="relative flex flex-1 flex-col justify-between min-w-0 gap-1 md:min-h-[110px]">
        <div className="relative pr-6">
          ...
          <div className="article-metaRow mt-1 md:mt-auto flex items-center justify-between">
            <div className="flex items-center gap-x-1 min-w-0 truncate pr-1">
              {article.cat && (
                <>
                  <span className="font-semibold text-[#e48d0b]">{article.cat}</span>
...
export default function HomeHeroSection() {
  ...
  return (
    <div className="space-y-6 lg:space-y-9">
      {/* ========== TOP BLOCK: ONE desktop structure from 768px+ (fluid columns) ========== */}
      <section className="grid grid-cols-1 gap-4 md:gap-6 md:grid-cols-[1fr_1.15fr] md:items-stretch
        ...
        <div className="flex h-full flex-col items-stretch gap-0 md:gap-2">
          <div className="grid grid-cols-1 md:grid-cols-2 items-stretch gap-0 md:gap-6">
            {row1.map((article) => (
              <SideCardWithImage key={article.id} article={article} />
            ))}
          </div>

          <div className="flex flex-1 flex-col items-stretch gap-0 md:gap-2">
            <div className="grid grid-cols-1 md:grid-cols-2 items-stretch gap-0 md:gap-6">
      ...
      {/* ========== BOTTOM STRIP: same 4-col desktop structure from 768px+ ========== */}
      <section className="hidden gap-4 md:gap-6 md:grid md:grid-cols-4 md:overflow-visible
                    md:items-stretch
                    md:shadow-[0_2px_3px_rgba(0,0,0,0.06),0_0_20px_rgba(0,0,0,0.06)]
                    md:p-7 md:bg-white dark:md:bg-[#121212]
                    md:border md:border-gray-200/0 dark:md:border-white/0
