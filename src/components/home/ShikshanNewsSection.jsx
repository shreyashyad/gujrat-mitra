...
function ImageCard({ article }) {
  ...
  return (
    <div
      ...
      className="group flex h-full flex-col justify-between md:min-h-[347px] cursor-pointer p-0
  ...
  return (
    <div
      ...
      className={`group relative flex h-full w-full cursor-pointer transition-transform duration-300 ease-out hover:-translate-y-0.5 active:scale-[0.985]
        flex-col justify-between md:min-h-[108px]
        ${className}`}
    >
...
export default function ShikshanNewsSection() {
  ...
  return (
    <section className="shadow-[0_2px_3px_rgba(0,0,0,0.06),0_0_20px_rgba(0,0,0,0.06)] p-7 bg-white dark:bg-[#121212] border border-gray-200/70 dark:border-white/10 rounded-3xl">
      ...
      {/* 
        < 768px → 1 column
        md+ (≥768) → single 4-column desktop layout
      */}
